...
//            System.getProperty("user.dir") + "/target/site/performance-reports/reservation-service-perf-report.html"))
//        .build();
//
//    @BeforeAll
//    @Transactional
...
//        
//        testScreening = screeningRepository.findById(testScreening.getId()).orElseThrow();
